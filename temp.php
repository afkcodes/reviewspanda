        ...
        <div class='wrapper'>
          <?php
                ...
                while ($i<count($cls) && $row = mysqli_fetch_array($popular)){
                    ...
                    echo '<div class="item '.($cls[$i]).' feature" style="background-image: url(/../admin/' .($row['file_dest']) . ');"> <a href="http://www.example.com"></a></div>';
                      $i++;
          ...
          <div class="col-md-7">
            ...
            <div class="row reviewbox ">
              ...
              <div class="col-md-8 content" >
                <div>
                  <a class ="title" href ="reviews.php?article_id='.base64_encode($row['0']).'"> ' .($row['edtopic']) . ' </a>
                </div>
                <div class="author">
